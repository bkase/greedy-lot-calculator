...
let () =
  ...
  Csv.save "/tmp/report.csv"
    ( [ "id"
      ...
      ; "long_gains_by_year"
      ; "long_gains_by_all"
      ; "short_basis_by_month"
      ; "short_basis_by_quarter"
      ; "short_basis_by_year"
      ; "short_basis_by_all"
      ; "short_sales_total_by_month"
      ; "short_sales_total_by_quarter"
      ; "short_sales_total_by_yeal"
      ; "short_sales_total_by_all"
      ; "long_basis_by_month"
      ; "long_basis_by_quarter"
      ; "long_basis_by_year"
      ; "long_basis_by_all"
      ; "long_sales_total_by_month"
      ; "long_sales_total_by_quarter"
      ; "long_sales_total_by_yeal"
      ; "long_sales_total_by_all"
      ]
    :: report ) ;
